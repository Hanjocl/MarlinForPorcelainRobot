 ...
 */
#if MANY(DELTA, MORGAN_SCARA, MP_SCARA, AXEL_TPARA, COREXY, COREXZ, COREYZ, COREYX, COREZX, COREZY, MARKFORGED_XY, MARKFORGED_YX, ROBOT_ARM, FOAMCUTTER_XYUV, POLAR)
  #error "Please enable only one of DELTA, MORGAN_SCARA, MP_SCARA, AXEL_TPARA, COREXY, COREXZ, COREYZ, COREYX, COREZX, COREZY, MARKFORGED_XY, MARKFORGED_YX, ROBOT_ARM, FOAMCUTTER_XYUV, or POLAR."
#endif
 ...
 */
#if HAS_Z_AXIS
  #warning "This firmware uses a custom homing sequence which does not allow for many homing features! Do NOT change ANY of the setting unless you really know what your are doing."
