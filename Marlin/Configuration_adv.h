...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 2, 2, 2 } // (linear=mm, rotational=°) One value for each linear axis
  #define BACKLASH_CORRECTION    0.9       // 0.0 = no correction; 1.0 = full correction
