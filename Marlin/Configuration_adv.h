...
#define HOMING_BACKOFF_POST_MM { 85, 85, 85 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 4.5, 4.5, 4 } // (linear=mm, rotational=°) One value for each linear axis
...
#define MINIMUM_STEPPER_PRE_DIR_DELAY 2000
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE_NS 1100
 ...
 */
#define STARTUP_COMMANDS "M75"  // Start print timer to make sure filament sensor always monitored (is not used in final build probably...)
